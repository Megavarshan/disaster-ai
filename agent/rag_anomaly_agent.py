...
async def analyze_dataset(file: UploadFile = File(...)):
    ...
    new_event = {
        ...
        "admissibility": { "admissibilityScore": 0.88, "decision": "execute", "reasoning": "High certainty and low distribution shift computed by Python Agent.", "threshold": 0.8, "reliability": 0.9, "normalizedMahalanobis": 1.2, "confidence": 0.95 },
        "explainability": { "summary": "Transformer identified patterns matching historical floods.", "contributions": [{ "feature": feature_col, "contribution": 45, "direction": "positive" }] }
    }
